...
class Save extends \DIT\OrderWorkflow\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('dit_orderworkflow/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('dit_orderworkflow/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('dit_orderworkflow/*/new');
                }
                return;
            } catch (\Exception $e) {
